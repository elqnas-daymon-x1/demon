#!/bin/bash
#my name is ELQNAS DAYMON i from egypt I Hacker 
...
figlet ELQNAS DAYMON 
printf "\n"
printf " \e[1;93m elqnas-daymon\e[0m \n"
printf " \033[1;35minstagram:elqnas_daymon | \033[1;34https://t.me/Daymon_Hack \e[0m \n"
printf "\n"
